...
CREATE INDEX IF NOT EXISTS idx_shop_sessions_session_id_covering 
...
CREATE INDEX IF NOT EXISTS idx_notifications_id_covering 
ON notifications(id) 
...
CREATE INDEX IF NOT EXISTS idx_shop_sessions_cleanup_optimized 
...
CREATE INDEX IF NOT EXISTS idx_notifications_cleanup_optimized 
...
CREATE INDEX IF NOT EXISTS idx_shop_sessions_active_shop_optimized 
...
CREATE INDEX IF NOT EXISTS idx_notifications_session_filtering 
...
CREATE INDEX IF NOT EXISTS idx_shop_sessions_heartbeat 
