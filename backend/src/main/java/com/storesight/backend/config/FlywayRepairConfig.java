...
/**
 * Configuration to handle Flyway checksum mismatches automatically
 * This is particularly useful for production deployments where migration files
 * may have been modified but the database still has old checksums
 */
@Configuration
@Profile("prod")
