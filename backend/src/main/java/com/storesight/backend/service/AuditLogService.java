...
public class AuditLogService {
    ...
    public void logExportAction(String shopDomain, String action, String type, Map<String, Object> details) {
        try {
    ...
    public Map<String, Object> getExportStats(String shopDomain) {
        ...
        try {
            ...
            if (shopOpt.isPresent()) {
                ...
                Long recentActivity = (long) auditLogRepository.findRecentByShop(shopId, thirtyDaysAgo).size();
                
                stats.put("exports", Map.of(
                    "png", pngExports,
                    "pdf", pdfExports,
                    "excel", excelExports,
