...
```
Caused by: java.net.UnknownHostException: dpg-d1d3qvumcj7s73fcu4jg-a
```

## 🔍 **Root Cause Analysis**

The error indicates that the PostgreSQL database host `dpg-d1d3qvumcj7s73fcu4jg-a` is not reachable. This is typically caused by:
...
Example:
```
postgresql://storesight_user:password@dpg-d1d3qvumcj7s73fcu4jg-a.oregon-postgres.render.com:5432/storesight
```
...
# Test DNS resolution
nslookup dpg-d1d3qvumcj7s73fcu4jg-a.oregon-postgres.render.com
```
